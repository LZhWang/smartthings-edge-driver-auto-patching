...
The `translator/` component of [EdgeLoom](../README.md), reachable as
`edgeloom translate`. Originally developed by Chuxiong Wu as HA2ST-Translator
and merged here with its history preserved.
